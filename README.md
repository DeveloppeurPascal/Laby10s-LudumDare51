...
This code repository contains the source files for the [Laby 10s](https://laby10s.gamolf.fr) video game developed in Delphi.

This video game was created during the Ludum Dare 51 game jam in October 2022, whose theme was “every 10 seconds”.

The player has to get out of a maze in less than 10 seconds to move on to the next board until death. The aim was to achieve the highest score.

This code repository contains a project developed in Object Pascal language under Delphi. You don't know what Delphi is and where to download it ? You'll learn more [on this web site](https://delphi-resources.developpeur-pascal.fr/).

## Using this video game

Visit [the Laby 10s website](https://laby10s.gamolf.fr) to download the compiled version, learn more about how it works, access videos and articles, find out about the different versions available and their features, contact user support...
...
To download this code repository, we recommend using "git", but you can also download a ZIP file directly from [its GitHub repository](https://github.com/DeveloppeurPascal/Laby10s-LudumDare51).
...
Documentation is exported in HTML by [DocInsight](https://devjetsoftware.com/products/documentation-insight/) or [PasDoc](https://pasdoc.github.io) to the /docs folder of the repository. You can also [access it online](https://developpeurpascal.github.io/Laby10s-LudumDare51) through the hosting offered by GitHub Pages.

Further information (tutorials, articles, videos, FAQ, talks and links) can be found on [the project website](https://laby10s.gamolf.fr/) or [the project devlog](https://developpeur-pascal.fr/laby10s.html).
...
If you detect any anomalies on earlier versions, please don't hesitate to [report them](https://github.com/DeveloppeurPascal/Laby10s-LudumDare51/issues) so that I can test and try to correct or provide a workaround.
...
If you want an answer from the project owner the best way to ask for a new feature or report a bug is to go to [the GitHub repository](https://github.com/DeveloppeurPascal/Laby10s-LudumDare51) and [open a new issue](https://github.com/DeveloppeurPascal/Laby10s-LudumDare51/issues).
